...
export function formatFormDataAsHtml(data: SendEmailRequest): string {
  const sections = [
    {
...
export function formatContactFormAsHtml(data: ContactFormRequest): string {
  return `
    <!DOCTYPE html>
    <html>
      <head>
...
export function formatQuizResultsAsHtml(data: QuizSubmissionRequest): string {
